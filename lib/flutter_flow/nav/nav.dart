...
class AppStateNotifier extends ChangeNotifier {
  MyRideFirebaseUser? initialUser;
  MyRideFirebaseUser? user;
  ...
  void update(MyRideFirebaseUser newUser) {
    initialUser ??= newUser;
    user = newUser;
          ...
          routes: [
            ...
            FFRoute(
              ...
              builder: (context, params) => VehicleDetailsWidget(
                ...
                dateOfBirth: params.getParam('dateOfBirth', ParamType.DateTime),
            ...
            FFRoute(
              name: 'SelectDateNTime',
              path: 'selectDateNTime',
              requireAuth: true,
              builder: (context, params) => SelectDateNTimeWidget(),
            ),
            FFRoute(
              name: 'OfferingFare',
              path: 'offeringFare',
              requireAuth: true,
              builder: (context, params) => OfferingFareWidget(),
            ),
            FFRoute(
              name: 'ContactDriver',
              path: 'contactDriver',
              requireAuth: true,
              builder: (context, params) => ContactDriverWidget(),
            ),
            FFRoute(
              name: 'Direction',
              path: 'direction',
            ...
            FFRoute(
              ...
              path: 'allRides',
              requireAuth: true,
              builder: (context, params) => AllRidesWidget(),
            ),
            FFRoute(
              name: 'Pay',
              path: 'pay',
            ...
            FFRoute(
              ...
              path: 'chooseYourTrip',
              requireAuth: true,
              builder: (context, params) => ChooseYourTripWidget(),
            ),
            FFRoute(
              name: 'DriverOffers',
              path: 'driverOffers',
              requireAuth: true,
              builder: (context, params) => DriverOffersWidget(),
            ),
            FFRoute(
              name: 'Co-Passengers',
              path: 'coPassengers',
              requireAuth: true,
              builder: (context, params) => CoPassengersWidget(),
            ),
            FFRoute(
              name: 'Notification',
              path: 'notification',
            ...
            FFRoute(
              ...
              path: 'onlineOffline',
              requireAuth: true,
              builder: (context, params) => OnlineOfflineWidget(),
            ),
            FFRoute(
              name: 'Delivery',
              path: 'delivery',
